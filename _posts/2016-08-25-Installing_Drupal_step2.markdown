...
I have this post in mind for those of us in the homeless app project using drupal. So I'm going to assume you read step one, [if not go back to step one]({% post_url 2016-08-21-Installing_Drupal_step1.markdown %}).
